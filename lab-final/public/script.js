    ...
    productList.append(`
      <div class="card" data-id="${id}">
        ...
        <div class="p">
          ...
          <!-- ✅ Add to Cart Button -->
          <button class="btn cart btn-add-cart" data-id="${id}">Add to Cart</button>
...
$(document).ready(function () {
  ...
  $(document).on("click", ".btn-add-cart", function () {
    ...
    $.ajax({
      ...
      method: "POST",
      contentType: "application/json",
      data: JSON.stringify({ productId, qty: 1 }),
      success: function () {
        alert("Added to cart ✅");
        // easiest way to see cart immediately
